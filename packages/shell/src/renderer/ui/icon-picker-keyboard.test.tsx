...
/**
 * KBN-S-pickers — the shell icon picker's tab row (horizontal tablist) and
 * skin-tone row (horizontal radiogroup, aria-checked) flow their roles through
 * `useCompositeKeyboard`; arrow keys switch tabs / tones.
 */
...
describe("IconPicker (shell) — KBN-S-pickers tablist + radiogroup keyboard", () => {
