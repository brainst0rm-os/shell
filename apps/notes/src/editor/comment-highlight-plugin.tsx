/**
 * Notes wrapper over the shared `<CommentHighlightPlugin>` (`@brainstorm/editor`)
...
import { CommentHighlightPlugin as SharedCommentHighlightPlugin } from "@brainstorm/editor";
